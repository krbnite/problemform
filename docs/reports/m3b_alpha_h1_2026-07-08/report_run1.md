...
**Run ID:** `2026-07-08T19-09-41_f39ffd`
**Started:** 2026-07-08T19:09:41+00:00
**Finished:** 2026-07-08T19:20:43+00:00
...
| Role | Total |
|---|---|
| ProblemForm refinement | 5m 41s |
| Answer generation | 1m 27s |
| Comparative judge | 12.8s |
| Rubric evaluation | 1m 24s |
| Property checks | 2m 18s |
| **Total** | **11m 02s** |
...
|---|---|---|---|---|
| addresses_stated_request | artifact | 0% | 20% | 5 |
| no_unnecessary_refusal | artifact | 100% | 100% | 5 |
| no_obvious_unsupported_facts | artifact | 80% | 80% | 5 |
...
| does_not_bloat_the_prompt_with_unnecessa_2 | formulation | 100% | 100% | 1 |
...
|---|---|---|---|---|
| what_causes_eclipses | formulation_quality_v1 | refined / material | +0.05 | P2 · answer material-win, formulation flat/negative |
| cosmology_nothingness | formulation_quality_v1 | tie / stylistic_only | +0.60 | P3 · answer tie, large formulation gain |
